...
namespace gw2stacks_blish.data
{
	class Translation
	{
		...
		public  List<string> english = new List<string>
		{
			...
			#region miscAdvice
			"Transform Quartz Crystals into a Charged Quartz Crystal at a place of power.",
			"Sift through silky sand.",
			"Craft 'Completed Aetherkey'.",
			"Consume to get War Supplies",
			"Consume to get Mordrem parts which can be exchanged for map currency",
			"Convert to Bauble Bubble",
			"Convert to Candy Corn Cob",
			"Convert to Jorbreaker",
			#endregion
			
			#region gameplay advice
			 "Trade to get bounty for bandit leader.",
			 "Have in inventory while defeating a bandit leader to spawn the Legendary Bandit Executioner",
			 "Use during a treasure hunt meta in Desert Highlands to spawn chests",
			 "Use in the Silverwastes after a meta completes to spawn chests. Make sure you have required keys.",
			 "Open a greater nightmare pod in the Silverwastes after completing meta.",
			 "Use during breach event in Silverwastes.",
			 "Open Tarnished chest in Silverwastes.",
			 "Open krait Sunken Chests to progress a Master Diver achievement.",
			 "Open chests in the Aetherpath of the Twilight Arbor dungeon.",
			 "Complete this bounty.",
			 "Complete events in the Verdant Brink.",
			 "Complete events in the Auric Basin.",
			 "Complete events in the Tangled Depths.",
			 "Contribute Spare Parts to kick off meta event in the Domain of Kourna.",
			 "Use in the Drizzlewood Coast to spawn chests. Make sure you have required keys.",
			 "Use to unlock achievements (and play in Drizzlewood Coast)",
			 "Use to unlock achievements (and play  Drizzlewood Coast)}, or just delete/tp when you are done.",
			#endregion
			...
			"Combine these items into stacks",
			"Sell these items to a vendor",
			"Salvage these items",
			"Sell these items on the TP",
			"Craft these items into higher luck tiers",
			"Delete these items",
			"Salvage Item", 
			"Feed these items to gobblers",
			"Consume these items for karma",
			"Consume these items for unbound magic",
			"Consume these items for volatile magic",
			"Convert these items to LWS4 currency",
			"Craft these items",
			#endregion
		...
		public List<string> german = new List<string>
		{
			...
			#region miscAdvice
			 "Verwandelt 25 Quarzkristalle an einem Ort der Macht in einen aufgeladenen Quarzkristall." ,
			 "Siebt 10 Haufen Sand für die Chance, etwas Wertvolles zu finden." ,
			 "Kombiniere zu 'Kompletter Ätherschlüssel'" ,
			 "Verwende für Kriegs-Vorräte" ,
			 "Verwende für Mordrem Teile und tausche diese geben Banditen-Wappen ein" ,
			 "Kombiniere zu Sphären-Blase" ,
			 "Kombiniere zu Candy-Corn-Kolben" ,
			 "Kombiniere zu Stück Jorzipan" ,
			#endregion
			
			#region gameplay advice
			 "Tausche für Banditeanführer Kopfgeldaufträge ein.",
			 "Habe es beim besiegen eines Banditenanführers im Inventar um einen Lengendären Banditen-Henker zu beschwören",
			 "Verwende im Wüsten-Hochland in der Schatzsuche",
			 "Verwende in der Silberwüste um Kisten auszugraben. Das Öffnen benötigt einen Schlüssel.",
			 "Verwende in der Silberwüste um die Größere Albtraum-Kapsel zu öffnen",
			 "Verwende während dem Bresche Event in der Silberwüste",
			 "Öffne Angelaufene Kisten in der Silberwüste.",
			 "Öffne Versunkene Krait Kisten.",
			 "Öffne Kisten im Ätherpfad des Zwielichtgartens",
			 "Absolviere diese Kopfgeldjagd.",
			 "Absolviere Events in der Grasgrünen Schwelle",
			 "Absolviere Events in dem Güldenen Talkessel.",
			 "Absolviere Events in den Verschlungenen Tiefen",
			 "Verwende um das Meta Event in Kourna zu starten",
			 "Verwende in der Nieselwald-Küste um Kisten zu finden. Das Öffnen benötigt einen Schlüssel.",
			 "Verwende um Erfolge zu erlangen( oder spiele in der Nieselwald-Küste)",
			"Verwende um Erfolge zu erlangen( oder spiele in der Nieselwald-Küste)}, oder lösche sie.",
			#endregion
			
			#region luck names
			 "Essenz des Glücks (Edel)" ,
			 "Essenz des Glücks (Meisterwerk)" ,
			 "Essenz des Glücks (Selten)" ,
			 "Essenz des Glücks (Exotisch)" ,
			 "Essenz des Glücks (Legendär)" ,
			#endregion
			...
			#region Model strings
			 ...
			 "Stapel diese Items" ,
			 "Verkaufe diese Items an einen NPC Händler" ,
			 "Verwerte diese Items wieder" ,
			 "Verkaufe diese Items auf dem Handelsposten" ,
			 "Bau höhere Glücksessenzen " ,
			 "Zerstöre diese Items" ,
			"Wiederverwertbarer Gegenstand" , 
			 "Füttere diese Items an einen Konvertierer" ,
			 "Verwende diese Items für Karma" ,
			 "Verwende diese Items für Entfesselte Magie" ,
			 "Verwende diese Items für Flüchtige Magie" ,
			"Tausche diese Items into LW4 Währungen" ,
			 "Baue diese Items" ,
			#endregion
			...
			#region advice names
			 "stapel vorschlag" ,
			 "verkäufer vorschlag" ,
			 "seltener wiedervertbarer vorschlag" ,
			 "baubare glückessenz vorschlag" ,
			 "zerstörbarer vorschlag" ,
			 "wiedervertbarer vorschlag" ,
			 "verwendbarer vorschlag" ,
			 "konvertierer vorschlag" ,
			 "karma verwendbarer vorschlag" ,
			 "bau vorschlag" ,
			 "lebendige welt vorschlag" ,
			 "diverser vorschlag" 
			#endregion
		};
	...
	{
		public MagicLists() { }
		public  List<int> karmaIds = new List<int>// contains "Karma" in description
		{
		...
		public List<int> salvageIds = new List<int> //contains "Salvage Item" in description
		{
		...
		public List<int> collectionOnlyIds = new List<int>//contains  "This item only has value as part of a collection" in description
		{
		...
		public List<int> gaetingSalvage = new List<int>()
		{
		...
		public List<int> magnetiteSalvage = new List<int>()
		{
	...
	class Magic
	{
		...
		public static  string get_current_translated_string(string tooltip_)
		{
			...
			var index = translation.english.FindIndex(item=>item.Contains(tooltip_));
			...
			else
			{
				switch (currentLocale)
				{
					...
					case Locale.English:
						return translation.english[index];

					case Locale.Spanish:
						return translation.spanish[index];

					case Locale.German:
						return translation.german[index];

					case Locale.French:
						return translation.french[index];

					case Locale.Korean:
						return translation.korean[index];

					case Locale.Chinese:
						return translation.chinese[index];
